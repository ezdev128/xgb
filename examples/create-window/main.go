...
func main() {
	...
	for {
		...
		case xproto.KeyPressEvent:
			// See https://pkg.go.dev/github.com/ezdev128/xgb/xproto#KeyPressEvent
		...
		case xproto.DestroyNotifyEvent:
			...
			// https://github.com/ezdev128/xgbutil/blob/master/_examples/graceful-window-close/main.go
			return
		}
	}
}
